...
return [
    ...
    */
    ...
    'dimensions'           => "Le dimensioni immagine di :attribut' non sono valide",
    ...
    */
    ...
    'custom' => [
        'vecchia_password' => [
            'required' => "Non hai inserito la vecchia password",
        ],
        'nuova_password' => [
            'required' => "Non hai inserito la nuova password",
        ],
        'username' => [
            'required' => "Non hai inserito lo username",
        ],
        'password' => [
            'required' => "Non hai inserito la password",
        ],
        'nome' => [
            'required' => "Non hai inserito il nome",
        ],
        'cognome' => [
            'required' => "Non hai inserito il cognome",
        ],
        'email' => [
            'required' => "Non hai inserito l'email",
        ],
        'età' => [
            'required' => "Non hai inserito l'età",
        ],
        'telefono' => [
    ...
    */
    ...
    'attributes' => [
        'vecchia_password' => 'La vecchia password',
        'nuova_password' => 'La nuova password',
        'nome' => 'Il nome',
        'cognome' => 'Il cognome',
        'email' => 'L\'email',
        'età' => 'L\'età',
