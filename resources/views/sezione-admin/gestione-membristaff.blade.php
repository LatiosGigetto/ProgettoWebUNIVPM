    ...
    <div class="spazio_blocco">
        ...
        <table>
            ...
            <tr>
                ...
                <td rowspan="3">
                    <button name="rimuovi membro dello staff 1" id="rimuovi membro dello staff 1">elimina membro dello
                        staff
                    </button>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>Azienda 4</td>
                <td>
                    <button name="rimuovi azquat da mem2" id="rimuovi azquat da mem2">elimina azienda assocciata
                    </button>
                </td>
                <td rowspan="2">
                    <button name="rimuovi membro dello staff 2" id="rimuovi membro dello staff 2">elimina membro dello
                        staff
                    </button>
                </td>
            </tr>
